...
/*typedef struct {
	int RminIndex,RmaxIndex,EDminIndex,EDmaxIndex;
	double RminNum,RmaxNum,EDminNum,EDmaxNum;
} layerCons;
*/
namespace GUICLR {
...
#define LV_SIGMA(n, nlp)      (2 * nlp + LV_PAR_SUBITEMS * n + 7)
	...
	public: 
		FitRange(ListView::ListViewItemCollection ^s, int layer, int nlp, FFModel *_model) {
			InitializeComponent();
