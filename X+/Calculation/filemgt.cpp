...
EXPORTED void ReadDataFile(const wchar_t *filename, vector<double>& x,
                  vector<double>& y)
{
	int i = 0, n = -1;
...
EXPORTED void Read1DDataFile(const wchar_t *filename, vector<double>& x)
{
	int i = 0, n = -1;
	ifstream in (filename);
...
EXPORTED void WriteDataFile(const wchar_t *filename, vector<double>& x,
				   vector<double>& y)
{
	FILE *fp;
...
EXPORTED void Write3ColDataFile(const wchar_t *filename, vector<double>& x,
...
EXPORTED void Write1DDataFile(const wchar_t *filename, vector<double>& x)
{
	FILE *fp;
...
EXPORTED void GetDirectory(const wchar_t *file, wchar_t *result, int n) {
...
EXPORTED void GetBasename(const wchar_t *file, wchar_t *result, int n) {
...
EXPORTED std::string GetDirectory(const string file) {
	char temp[256] = {0};
...
EXPORTED std::string GetBasename(const string file) {
	char temp[256] = {0};
