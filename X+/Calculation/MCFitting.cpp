...
MCLMFitter::MCLMFitter(Model *model, const std::vector<double>& datax, 
		   ...
		   int layers)  : LMFitter(model, datax, datay, factor, bg,
                                    fitWeights, p, pmut, pMin, pMax, paramErrors, modelErrors, layers) {
    if(!randInit) {
