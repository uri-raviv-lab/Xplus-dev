...
TRAModel::TRAModel(std::string st, int extras, int nlp, int minlayers,
				...
				Model(st, extras, nlp, minlayers, maxlayers, edp) {
	numModels = 0;
}
...
double TRAModel::GetDefaultParamValue(int paramIndex, int layer) {
	return 1.0;
} 


std::string TRAModel::GetLayerParamName(int index) {
	if(index == 0)
		return "Weight";
...
#pragma region Predefined Model
