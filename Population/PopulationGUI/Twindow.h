...
#include "WGTControl.h"	// Causes linking errors (may be the same problem as ReadDataFile not working
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->variableDataGridView->AlternatingRowsDefaultCellStyle = dataGridViewCellStyle1;
...
#pragma endregion
	private: System::Void exprFlowLayoutPanel_Resize(System::Object^  sender, System::EventArgs^  e);
		...
		//////////////////
			 ...
			 void draw();
			 void LoadFile(System::Object ^sender);
